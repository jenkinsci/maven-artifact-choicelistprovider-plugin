...
public class MACLPPipelineParameterNexus3Generic extends MACLPChoiceParameterDefinitionBase {
    ...
    public MACLPPipelineParameterNexus3Generic(
            String name,
            String choices,
            String description,
            String url,
    ...
    protected MultivaluedMap<String, String> createParameterList() {
        ...
        Nexus3RESTfulParameterBuilderForGenericArtifacts mapper =
                new Nexus3RESTfulParameterBuilderForGenericArtifacts();
    ...
    public boolean equals(Object obj) {
        if (MACLPPipelineParameterNexus3Generic.class != getClass()) return super.equals(obj);
        ...
        if (!Objects.equals(assetName, other.getAssetName())) return false;
