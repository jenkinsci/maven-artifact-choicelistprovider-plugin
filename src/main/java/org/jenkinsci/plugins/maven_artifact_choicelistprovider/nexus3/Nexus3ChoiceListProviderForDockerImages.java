...
public class Nexus3ChoiceListProviderForDockerImages extends AbstractMavenArtifactChoiceListProvider {
    ...
    public static class Nexus3DockerImageDescriptorImpl extends Descriptor<ChoiceListProvider> {
        ...
        private Map<String, String> readURL(
                final IVersionReader2 pInstance,
            ...
            try {
                MultivaluedMap<String, String> params =
                        Nexus3RESTfulParameterBuilderForSearch.create(pRepository, "", pName);
                ...
                LOGGER.log(
                        Level.INFO,
                        "failed to retrieve versions from repository for r:" + pRepository + ", n:" + pName,
                        e);
                retVal.put("error", e.getMessage());
            } catch (Exception e) {
                LOGGER.log(
                        Level.WARNING,
                        "failed to retrieve versions from nexus for r:" + pRepository + ", n:" + pName,
                        e);
